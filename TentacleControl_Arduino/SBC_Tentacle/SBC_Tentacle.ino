...
const int sma []= {11, 10, 9, 8, 7, 6, 5, 4, 3, 12};
...
const double sma_duty_steady [numLevel] = {0.1/v_supp, 1.9/v_supp, 2.3/v_supp, 2.6/v_supp, 2.7/v_supp, 3.0/v_supp, 3.4/v_supp, 3.6/v_supp, 4.0/v_supp, 4.7/v_supp};
